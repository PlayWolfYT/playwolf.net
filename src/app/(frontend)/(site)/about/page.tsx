...
export default async function AboutPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 pb-24 pt-16 sm:px-8 sm:pt-24">
      ...
      <div className="mt-12 rounded-3xl border border-white/[0.07] bg-linear-to-br from-void-lift/90 to-void-panel/70 px-6 py-8 shadow-glow-sm backdrop-blur-xl sm:px-10 sm:py-10">
        {about ? (
          <RichTextContent
