  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 pb-24 pt-16 sm:px-8 sm:pt-24">
      ...
      <section className="text-center">
        ...
        <h1 className="mx-auto mt-6 max-w-3xl font-display text-4xl font-light leading-tight tracking-tight text-parchment sm:text-5xl">
          {settings.heroTitle ?? FALLBACK_TITLE}
        </h1>
